...
angular.module('myApp.controllers', ['firebase.utils', 'simpleLogin'])
  ...
  .controller('ApplicationCtrl', ['$scope', 'messageList', function($scope, messageList) {
      $scope.apply = function(name, email, school, phone, github, linkedin, hackathons, projects, team) {
        $scope.err = null;
        simpleLogin.apply(name, email, school, phone, github, linkedin, hackathons, projects, team)
          .then(function(/* user */) {
